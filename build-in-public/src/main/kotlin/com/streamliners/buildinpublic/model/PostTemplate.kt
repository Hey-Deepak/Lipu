...
/**
 * LinkedIn post templates mapped to diff categories.
 */
enum class PostTemplate(
    ...
    FEATURE_ANNOUNCEMENT(
        ...
        structure = """
            |🔨 Building in public: {{APP_NAME}} Day {{DAY_NUMBER}}
            |
    ...
    TECHNICAL_DEEP_DIVE(
        ...
        structure = """
            ...
            |The goal: {{USER_GOAL}}
            |
            |The tech stack for this feature:
            |{{TECH_STACK}}
            |
    ...
    companion object {
        /**
         * Find the best template for a given diff category.
         */
